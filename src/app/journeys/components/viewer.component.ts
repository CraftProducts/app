...
import { LoadTemplateAction, SelectSectionAction, SetModelDirtyAction } from '../+state/journey.actions';
import { Subscription } from 'rxjs';
import { ComponentCanDeactivate } from 'shared-lib'

@Component({
    selector: 'app-journey-viewer',
    templateUrl: './viewer.component.html'
})
export class JourneyViewerComponent implements ComponentCanDeactivate, OnInit, OnDestroy {
    public zoom = 100;
    editorVisible = false;
    mode = "VIEW";
    section: string;
    ...
    constructor(public store$: Store<JourneyState>, public activatedRoute: ActivatedRoute) {
    }
    ...
    ngOnInit() {
        ...
        this.selectedSection$ = this.store$.select(p => p.journey.selectedSection)
